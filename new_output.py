...
def nice_printer(difference):
    ...
    for i in range(len(two_arrays[1])):
        print(str(i*percentage)+str("% --> ")+str(((i*percentage)+percentage))+ str("%")+"       "+str(two_arrays[1][i]))
    ...
    for i in range(len(two_arrays[0])):
        print(str(-i*percentage)+str("% --> ")+str((-i*percentage)-percentage)+ str("%")+"       "+str(two_arrays[0][i]))    
...
nice_printer(ratio)   #the interval error table
